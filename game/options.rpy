...
init -1 python hide:
    ...
    config.window_title = u"Starcrossed"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Starcrossed"
    config.version = "0.0"
    ...
    config.main_menu_music = "music/bensound/bensound-memories.mp3"
...
python early:
    config.save_directory = "Starcrossed-1461248873"
